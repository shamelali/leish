...
SELECT id, email, created_at FROM auth.users WHERE email LIKE '%@leish.my' ORDER BY created_at;

-- Done! You can now sign in with:
-- Email: artist@leish.my, Password: password123
-- Email: customer@leish.my, Password: password123
-- Email: admin@leish.my, Password: password123
-- Email: studio@leish.my, Password: password123
