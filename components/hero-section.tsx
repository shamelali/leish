  ...
  return (
    <section className="relative overflow-hidden bg-secondary">
      <div className="mx-auto flex max-w-7xl flex-col items-center px-4 sm:px-6 lg:flex-row lg:px-8">
        {/* Text content */}
        <div className="flex flex-1 flex-col items-start justify-center py-8 sm:py-20 lg:py-32">
          ...
          <h1 className="mt-4 sm:mt-6 font-serif text-[1.65rem] sm:text-5xl font-semibold leading-[1.1] sm:leading-[1.02] tracking-[-0.03em] sm:tracking-[-0.04em] text-foreground md:text-6xl lg:text-7xl">
          ...
          <div className="mt-5 sm:mt-10 flex flex-col gap-2.5 sm:gap-4 w-full sm:w-auto">
            <Link
              href="/artists"
