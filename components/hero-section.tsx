  ...
  return (
    <section className="relative overflow-hidden bg-secondary">
      ...
      <button
        ...
        className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 z-20 flex size-9 sm:size-11 items-center justify-center rounded-full bg-white/80 text-foreground shadow-md backdrop-blur-sm transition-all hover:bg-white"
      ...
      <button
        ...
        className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 z-20 flex size-9 sm:size-11 items-center justify-center rounded-full bg-white/80 text-foreground shadow-md backdrop-blur-sm transition-all hover:bg-white"
        aria-label="Next slide"
      >
        <ChevronRight className="size-4 sm:size-5" />
      </button>

      <div className="absolute bottom-4 sm:bottom-6 left-1/2 z-20 flex -translate-x-1/2 items-center gap-2 rounded-full bg-black/25 px-3 py-1.5 backdrop-blur-sm">
        {SLIDES.map((slide, index) => (
          <button
            key={`${slide.image}-dot`}
            type="button"
