...
export default async function StudioOnboardingPage() {
    ...
    return (
      <div className="mx-auto max-w-md px-4 py-24 text-center">
        ...
        <div className="mt-6 flex items-center justify-center gap-4">
          ...
          <Link
            href="https://www.leish.my/sign-up"
  ...
  if (existing) {
    return (
      <div className="mx-auto max-w-md px-4 py-24 text-center">
        <h1 className="font-serif text-2xl text-foreground">Studio already set up</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          You already have a studio: <strong>{existing.display_name}</strong>.
        </p>
        <div className="mt-6 flex items-center justify-center gap-4">
          <Link
            href={`/${existing.slug}`}
