...
- The migration has **not yet been applied to a live database** — apply it via the repo's normal Supabase migration flow before enabling engine UIs in production.
